...
float4 PixelMain(v2p_t input) : SV_Target0
{
    ...
    resultingColor.r = 0.01f / (1.005f - resultingColor.r); // IDK borrowed Vignesh's formula
    resultingColor.g = resultingColor.r; // IDK borrowed Vignesh's formula
    resultingColor.b = resultingColor.r; // IDK borrowed Vignesh's formula
